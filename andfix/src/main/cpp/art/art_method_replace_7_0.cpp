...
/*	reinterpret_cast<art::mirror::Class*>(dmeth->declaring_class_)->status_ =
    ...
    int a = (reinterpret_cast<art::mirror::Class*>(smeth->declaring_class_)->status_) -1;//hwh change
    reinterpret_cast<art::mirror::Class*>(dmeth->declaring_class_)->status_ = static_cast<art::mirror::Class::Status>(a);
